...
export const API_ENDPOINTS = {
  PROBLEM: '/api/problems',           // Fetch random coding problems
  SUBMIT: '/api/code/submit',         // Submit code for AI evaluation
  HINT: '/api/code/hint',             // Request hints for current problem
  REGISTER: '/api/users/register',    // Register new user in backend
  COMPLETE: '/api/users/complete',    // Mark problem as completed
